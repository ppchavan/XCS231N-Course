...
class KNearestNeighbor(object):
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            k_selected_indices = sorted_indices[:k]
            closest_y = self.y_train[k_selected_indices]
            # ### END CODE HERE ###
            #########################################################################
            # TODO:                                                                 #
            ...
            # Get all labels that appear max_count times
            most_common_labels = [label for label, count in label_counts.items() if count == max_count]
            # Choose the smallest label among the most common ones
